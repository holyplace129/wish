...
public class WishUpdateRequest {
    ...
    @Builder
    public WishUpdateRequest(String title, String content, String image, Long price, Long dayDeposit, LocalDate startAt, Frequency frequency, String dayOfWeek, Integer dayOfMonth) {
        this.title = title;
